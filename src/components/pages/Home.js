...
const Root = () => {
    ...
    useEffect(() => {
        const resize = () => {
            ...
            window.innerWidth > 991 ? setIsFilterOpen(true) : setIsFilterOpen(false)
        }
        ...
        <div className = 'home'>
                                ...
                                <section className = "price-content">
                                    ...
                                    <div className = "container-button">
                                        <button 
                                            ...
                                            onClick = {e => filterProducts(e, fromPrice, toPrice)}
                                        >
                                            <p className = "filter-price">Filter price</p>
                                        </button>
                                    </div>
                                    <div className = "box-hide"></div>
                                    <div 
                                        className = {`${
                                            !isPriceDown ? 'drop-up-content' : 'drop-down-content'
                                        } box-hide`}>
                                    </div>
                                </section>
                            </section>
                            <section className = {`subtitle vertical-padding ${!isPriceDown ? 'slow-up' : 'slow-down'}`}>
                                <div className = "category-content">
                                    ...
                                    <ul className = 'category-list'>
                                        ...
                                        <div
                                            className = {`${
                                                !isCategoryDown ? 'drop-up-content' : 'drop-down-content'
                                            } box-hide`}>
                                        </div>
                                    </ul>
                                </div>
            ...
            <main className = 'main'>
                <header className = 'header'>
                    <form action = "" onSubmit = {(e) => searchProducts(e)} className = 'form-flex'>
                        <input
                            type = "text"
                                        ...
                                        <div className = 'product'>
                                            <Link to = {`/product/${product.id}`}>
                                                ...
                                                <div className = "container-info-product">
                                                    ...
                                                    <div className = "container-button">
                                                        <button 
                                                            className = "button-shop-cart" 
                                                            onClick = {e => addProductsToCart(e, product.id)}
                                                        >
